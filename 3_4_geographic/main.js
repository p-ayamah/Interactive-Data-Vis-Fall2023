...
const legendValues = [100, 1000, 2000, 3000, 5000]; // Adjust these values based on your data
...
Promise.all([
  ...
  // Create a Set of countries from the CSV file
  ...
  // Create a scale for circle size based on the "Count" column
  ...
  svg
    ...
    .attr("font-size", "20px")
    .text("Choropleth Map with Circle Sizes");
